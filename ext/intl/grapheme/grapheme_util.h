...
UBreakIterator* grapheme_get_break_iterator(void *stack_buffer, UErrorCode *status, TSRMLS_D );
...
int
grapheme_strpos_utf16(unsigned char *haystack, int32_t haystack_len, unsigned char*needle, int32_t needle_len, int32_t offset, int *puchar_pos, int f_ignore_case, TSRMLS_D);
