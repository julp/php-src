...
U_CFUNC PHP_FUNCTION(intltz_create_time_zone)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "s",
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_time_zone: bad arguments", 0, TSRMLS_C);
		RETURN_NULL();
	}
	...
	if (intl_stringFromChar(id, str_id, str_id_len, &status) == FAILURE) {
		intl_error_set(NULL, status,
			"intltz_create_time_zone: could not convert time zone id to UTF-16", 0, TSRMLS_C);
		RETURN_NULL();
	}
...
U_CFUNC PHP_FUNCTION(intltz_from_date_time_zone)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "O",
			&zv_timezone, php_date_get_timezone_ce()) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_from_date_time_zone: bad arguments", 0, TSRMLS_C);
		RETURN_NULL();
	}

	tzobj = (php_timezone_obj *)zend_objects_get_address(zv_timezone, TSRMLS_C);
	...
	tz = timezone_convert_datetimezone(tzobj->type, tzobj, FALSE, NULL,
		"intltz_from_date_time_zone", TSRMLS_C);
	if (tz == NULL) {
		RETURN_NULL();
	}
...
U_CFUNC PHP_FUNCTION(intltz_create_default)
{
	...
	if (zend_parse_parameters_none() == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_default: bad arguments", 0, TSRMLS_C);
		RETURN_NULL();
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_gmt)
{
	...
	if (zend_parse_parameters_none() == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_gmt: bad arguments", 0, TSRMLS_C);
		RETURN_NULL();
	}

	timezone_object_construct(TimeZone::getGMT(), return_value, 0, TSRMLS_C);
}
...
U_CFUNC PHP_FUNCTION(intltz_get_unknown)
{
	...
	if (zend_parse_parameters_none() == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_unknown: bad arguments", 0, TSRMLS_C);
		RETURN_NULL();
	}

	timezone_object_construct(&TimeZone::getUnknown(), return_value, 0, TSRMLS_C);
}
#endif
...
U_CFUNC PHP_FUNCTION(intltz_create_enumeration)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "|Z", &arg) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_enumeration: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
int_offset:
		if (Z_LVAL_PP(arg) < (long)INT32_MIN ||
			...
			intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
				"intltz_create_enumeration: value is out of range", 0, TSRMLS_C);
			RETURN_FALSE;
		} else {
...
double_offset:
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_enumeration: invalid argument type", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (se) {
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_enumeration: error obtaining enumeration", 0, TSRMLS_C);
		RETVAL_FALSE;
	}
}
...
U_CFUNC PHP_FUNCTION(intltz_count_equivalent_ids)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "s",
			&str_id, &str_id_len) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_count_equivalent_ids: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (intl_stringFromChar(id, str_id, str_id_len, &status) == FAILURE) {
		intl_error_set(NULL, status,
			"intltz_count_equivalent_ids: could not convert time zone id to UTF-16", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_create_time_zone_id_enumeration)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "l|s!l",
			&zoneType, &region, &region_len, &offset_arg) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_time_zone_id_enumeration: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (zoneType != UCAL_ZONE_TYPE_ANY && zoneType != UCAL_ZONE_TYPE_CANONICAL
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_create_time_zone_id_enumeration: bad zone type", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (ZEND_NUM_ARGS() == 3) {
		if (offset_arg < (long)INT32_MIN || offset_arg > (long)INT32_MAX) {
			intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
				"intltz_create_time_zone_id_enumeration: offset out of bounds", 0, TSRMLS_C);
			RETURN_FALSE;
		}
...
U_CFUNC PHP_FUNCTION(intltz_get_canonical_id)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "s|z",
			&str_id, &str_id_len, &is_systemid) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_canonical_id: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (intl_stringFromChar(id, str_id, str_id_len, &status) == FAILURE) {
		intl_error_set(NULL, status,
			"intltz_get_canonical_id: could not convert time zone id to UTF-16", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_region)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "s",
			&str_id, &str_id_len) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_region: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (intl_stringFromChar(id, str_id, str_id_len, &status) == FAILURE) {
		intl_error_set(NULL, status,
			"intltz_get_region: could not convert time zone id to UTF-16", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_tz_data_version)
{
	...
	if (zend_parse_parameters_none() == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_tz_data_version: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_equivalent_id)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), TSRMLS_C, "sl",
			&str_id, &str_id_len, &index) == FAILURE ||
			index < (long)INT32_MIN || index > (long)INT32_MAX) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_equivalent_id: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (intl_stringFromChar(id, str_id, str_id_len, &status) == FAILURE) {
		intl_error_set(NULL, status,
			"intltz_get_equivalent_id: could not convert time zone id to UTF-16", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_id)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "O",
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_id: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_use_daylight_time)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "O",
			&object, TimeZone_ce_ptr) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_use_daylight_time: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_offset)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_offset: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_raw_offset)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_raw_offset: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_has_same_rules)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
			...
			== FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_has_same_rules: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	TIMEZONE_METHOD_FETCH_OBJECT;
	other_to = (TimeZone_object *) zend_object_store_get_object(other_object, TSRMLS_C);
	if (other_to->utimezone == NULL) {
		intl_errors_set(&to->err, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_has_same_rules: The second IntlTimeZone is unconstructed", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_display_name)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
		...
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_display_name: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	if (!found) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_display_name: wrong display type", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_get_dst_savings)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
			"O", &object, TimeZone_ce_ptr) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_dst_savings: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
U_CFUNC PHP_FUNCTION(intltz_to_date_time_zone)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(),
			"O", &object, TimeZone_ce_ptr) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_to_date_time_zone: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}
	...
	zval *ret = timezone_convert_to_datetimezone(to->utimezone,
		&TIMEZONE_ERROR(to), "intltz_to_date_time_zone", TSRMLS_C);
...
U_CFUNC PHP_FUNCTION(intltz_get_error_code)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "O",
			&object, TimeZone_ce_ptr) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_error_code: bad arguments", 0, TSRMLS_C);
		RETURN_FALSE;
	}

	/* Fetch the object (without resetting its last error code ). */
	to = (TimeZone_object*)zend_object_store_get_object(object, TSRMLS_C);
	if (to == NULL)
		RETURN_FALSE;
...
U_CFUNC PHP_FUNCTION(intltz_get_error_message)
{
	...
	if (zend_parse_method_parameters(ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "O",
			&object, TimeZone_ce_ptr) == FAILURE) {
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_get_error_message: bad arguments", 0, TSRMLS_C );
		RETURN_FALSE;
	}
	...
	message = intl_error_get_message(TIMEZONE_ERROR_P(to), TSRMLS_C);
