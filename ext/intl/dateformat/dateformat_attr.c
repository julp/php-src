...
PHP_FUNCTION( datefmt_get_datetype )
{
	...
	/* Parse parameters. */
	if( zend_parse_method_parameters( ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "O", &object, IntlDateFormatter_ce_ptr ) == FAILURE )
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,	
			"datefmt_get_datetype: unable to parse input params", 0, TSRMLS_C );
		RETURN_FALSE;
	}
...
PHP_FUNCTION( datefmt_get_timetype )
{
	...
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,	
			"datefmt_get_timetype: unable to parse input params", 0, TSRMLS_C );
		RETURN_FALSE;
	}
...
PHP_FUNCTION( datefmt_get_pattern )
{
	...
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,	
			"datefmt_get_pattern: unable to parse input params", 0, TSRMLS_C );
		RETURN_FALSE;
	}
...
PHP_FUNCTION( datefmt_set_pattern )
{
	...
	{
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,	
			"datefmt_set_pattern: unable to parse input params", 0, TSRMLS_C);
		RETURN_FALSE;
	}
...
PHP_FUNCTION( datefmt_get_locale )
{
	...
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"datefmt_get_locale: unable to parse input params", 0, TSRMLS_C );
...
PHP_FUNCTION( datefmt_is_lenient )
{
	...
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"datefmt_is_lenient: unable to parse input params", 0, TSRMLS_C );
...
PHP_FUNCTION( datefmt_set_lenient )
{
	...
	/* Parse parameters. */
	if( zend_parse_method_parameters( ZEND_NUM_ARGS(), TSRMLS_C, getThis(), "Ob",
	&object, IntlDateFormatter_ce_ptr,&isLenient ) == FAILURE )
	{
		intl_error_set( NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"datefmt_set_lenient: unable to parse input params", 0, TSRMLS_C );
		RETURN_FALSE;
	}
