...
php_oci_collection * php_oci_collection_create(php_oci_connection *connection, char *tdo, int tdo_len, char *schema, int schema_len, TSRMLS_D)
{	
	dvoid *dschp1 = NULL;
	dvoid *parmp1;
	dvoid *parmp2;
	...
	switch(collection->coll_typecode) {
		...
		default:
			php_error_docref(NULL, TSRMLS_C, E_WARNING, "unknown collection type %d", collection->coll_typecode);
			break;
	}	
...
int php_oci_collection_size(php_oci_collection *collection, sb4 *size, TSRMLS_D)
{
...
int php_oci_collection_max(php_oci_collection *collection, long *max, TSRMLS_D)
{
	php_oci_connection *connection = collection->connection;
...
int php_oci_collection_trim(php_oci_collection *collection, long trim_size, TSRMLS_D)
{
	php_oci_connection *connection = collection->connection;
...
int php_oci_collection_append_null(php_oci_collection *collection, TSRMLS_D)
{
...
int php_oci_collection_append_date(php_oci_collection *collection, char *date, int date_len, TSRMLS_D)
{
...
int php_oci_collection_append_number(php_oci_collection *collection, char *number, int number_len, TSRMLS_D)
{
	OCIInd new_index = OCI_IND_NOTNULL;
...
int php_oci_collection_append_string(php_oci_collection *collection, char *element, int element_len, TSRMLS_D)
{
	OCIInd new_index = OCI_IND_NOTNULL;
...
int php_oci_collection_append(php_oci_collection *collection, char *element, int element_len, TSRMLS_D)
{
	if (element_len == 0) {
		return php_oci_collection_append_null(collection, TSRMLS_C);
	}
	
	switch(collection->element_typecode) {
		case OCI_TYPECODE_DATE:
			return php_oci_collection_append_date(collection, element, element_len, TSRMLS_C);
			break;
			
		case OCI_TYPECODE_VARCHAR2 :
			return php_oci_collection_append_string(collection, element, element_len, TSRMLS_C);
			break;
		...
		case OCI_TYPECODE_SMALLINT :								/* SMALLINT */
			return php_oci_collection_append_number(collection, element, element_len, TSRMLS_C);
			break;

		default:
			php_error_docref(NULL, TSRMLS_C, E_NOTICE, "Unknown or unsupported type of element: %d", collection->element_typecode);
			return 1;
			break;
	}
	/* never reached */
...
int php_oci_collection_element_get(php_oci_collection *collection, long index, zval **result_element, TSRMLS_D)
{
	php_oci_connection *connection = collection->connection;
	dvoid *element;
...
int php_oci_collection_element_set_null(php_oci_collection *collection, long index, TSRMLS_D)
{
	OCIInd null_index = OCI_IND_NULL;
	php_oci_connection *connection = collection->connection;
...
int php_oci_collection_element_set_date(php_oci_collection *collection, long index, char *date, int date_len, TSRMLS_D)
{
	OCIInd new_index = OCI_IND_NOTNULL;
	OCIDate oci_date;
	php_oci_connection *connection = collection->connection;
...
int php_oci_collection_element_set_number(php_oci_collection *collection, long index, char *number, int number_len, TSRMLS_D)
{
	OCIInd new_index = OCI_IND_NOTNULL;
	double element_double;
	OCINumber oci_number;
...
int php_oci_collection_element_set_string(php_oci_collection *collection, long index, char *element, int element_len, TSRMLS_D)
{
	OCIInd new_index = OCI_IND_NOTNULL;
	OCIString *ocistr = (OCIString *)0;
	php_oci_connection *connection = collection->connection;
...
int php_oci_collection_element_set(php_oci_collection *collection, long index, char *value, int value_len, TSRMLS_D)
{
	if (value_len == 0) {
		return php_oci_collection_element_set_null(collection, index, TSRMLS_C);
	}
	
	switch(collection->element_typecode) {
		case OCI_TYPECODE_DATE:
			return php_oci_collection_element_set_date(collection, index, value, value_len, TSRMLS_C);
			break;
			
		case OCI_TYPECODE_VARCHAR2 :
			return php_oci_collection_element_set_string(collection, index, value, value_len, TSRMLS_C);
			break;
		...
		case OCI_TYPECODE_NUMBER :									/* NUMBER	*/
		case OCI_TYPECODE_SMALLINT :								/* SMALLINT */
			return php_oci_collection_element_set_number(collection, index, value, value_len, TSRMLS_C);
			break;
...
int php_oci_collection_assign(php_oci_collection *collection_dest, php_oci_collection *collection_from, TSRMLS_D)
{
...
void php_oci_collection_close(php_oci_collection *collection, TSRMLS_D)
{
	php_oci_connection *connection = collection->connection;
