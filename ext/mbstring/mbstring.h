...
MBSTRING_API char * php_mb_convert_encoding(const char *input, size_t length,
                                      ...
                                      size_t *output_len, TSRMLS_D);

MBSTRING_API int php_mb_check_encoding_list(const char *encoding_list, TSRMLS_D);
