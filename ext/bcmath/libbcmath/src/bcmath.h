...
_PROTOTYPE(void bc_init_num, (bc_num *num, TSRMLS_D));

_PROTOTYPE(void bc_str2num, (bc_num *num, char *str, int scale, TSRMLS_D));
...
_PROTOTYPE(char bc_is_zero, (bc_num num, TSRMLS_D));
...
_PROTOTYPE(void bc_multiply, (bc_num n1, bc_num n2, bc_num *prod, int scale, TSRMLS_D));

_PROTOTYPE(int bc_divide, (bc_num n1, bc_num n2, bc_num *quot, int scale, TSRMLS_D));
...
_PROTOTYPE(int bc_divmod, (bc_num num1, bc_num num2, bc_num *quot,
			   bc_num *rem, int scale, TSRMLS_D));

_PROTOTYPE(int bc_raisemod, (bc_num base, bc_num expo, bc_num mod,
			     bc_num *result, int scale, TSRMLS_D));

_PROTOTYPE(void bc_raise, (bc_num num1, bc_num num2, bc_num *result,
			   int scale, TSRMLS_D));

_PROTOTYPE(int bc_sqrt, (bc_num *num, int scale, TSRMLS_D));

_PROTOTYPE(void bc_out_num, (bc_num num, int o_base, void (* out_char)(int),
			     int leading_zero, TSRMLS_D));
