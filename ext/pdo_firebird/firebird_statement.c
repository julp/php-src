...
#define RECORD_ERROR(stmt) _firebird_error(NULL, stmt,  __FILE__, __LINE__, TSRMLS_C)
...
static int firebird_stmt_dtor(pdo_stmt_t *stmt, TSRMLS_D) /* {{{ */
{
...
static int firebird_stmt_execute(pdo_stmt_t *stmt, TSRMLS_D) /* {{{ */
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
...
static int firebird_stmt_describe(pdo_stmt_t *stmt, int colno, TSRMLS_D) /* {{{ */
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
...
static int firebird_fetch_blob(pdo_stmt_t *stmt, int colno, char **ptr, /* {{{ */
	unsigned long *len, ISC_QUAD *blob_id, TSRMLS_D)
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
	pdo_firebird_db_handle *H = S->H;
...
static int firebird_bind_blob(pdo_stmt_t *stmt, ISC_QUAD *blob_id, zval *param, TSRMLS_D)
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
	pdo_firebird_db_handle *H = S->H;
	...
	enum pdo_param_event event_type, TSRMLS_D)
{
	...
	switch (event_type) {
		...
		case PDO_PARAM_EVT_FETCH_POST:
			...
			if (firebird_stmt_get_col(stmt, param->paramno, &value, &value_len, &caller_frees, TSRMLS_C)) {
...
static int firebird_stmt_set_attribute(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D) /* {{{ */
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
...
static int firebird_stmt_get_attribute(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D) /* {{{ */
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
...
static int firebird_stmt_cursor_closer(pdo_stmt_t *stmt, TSRMLS_D) /* {{{ */
{
	pdo_firebird_stmt *S = (pdo_firebird_stmt*)stmt->driver_data;
