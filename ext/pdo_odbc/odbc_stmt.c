...
static void free_cols(pdo_stmt_t *stmt, pdo_odbc_stmt *S, TSRMLS_D)
{
	if (S->cols) {
		int i;
...
static int odbc_stmt_dtor(pdo_stmt_t *stmt, TSRMLS_D)
{
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
...
static int odbc_stmt_execute(pdo_stmt_t *stmt, TSRMLS_D)
{
	RETCODE rc;
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
	char *buf = NULL;
...
static int odbc_stmt_describe(pdo_stmt_t *stmt, int colno, TSRMLS_D)
{
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
...
static int odbc_stmt_get_col(pdo_stmt_t *stmt, int colno, char **ptr, unsigned long *len, int *caller_frees, TSRMLS_D)
{
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
...
static int odbc_stmt_set_param(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D)
{
	SQLRETURN rc;
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
...
static int odbc_stmt_get_attr(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D)
{
	SQLRETURN rc;
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
...
static int odbc_stmt_next_rowset(pdo_stmt_t *stmt, TSRMLS_D)
{
	SQLRETURN rc;
	SQLSMALLINT colcount;
	pdo_odbc_stmt *S = (pdo_odbc_stmt*)stmt->driver_data;
