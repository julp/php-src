...
extern int _pdo_mysql_error(pdo_dbh_t *dbh, pdo_stmt_t *stmt, const char *file, int line, TSRMLS_D);
#define pdo_mysql_error(s) _pdo_mysql_error(s, NULL, __FILE__, __LINE__, TSRMLS_C)
#define pdo_mysql_error_stmt(s) _pdo_mysql_error(stmt->dbh, stmt, __FILE__, __LINE__, TSRMLS_C)
