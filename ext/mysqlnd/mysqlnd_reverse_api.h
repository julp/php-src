...
typedef struct st_mysqlnd_reverse_api
{
	...
	MYSQLND *(*conversion_cb)(zval * zv, TSRMLS_D);
} MYSQLND_REVERSE_API;
...
PHPAPI void mysqlnd_reverse_api_register_api(MYSQLND_REVERSE_API * apiext, TSRMLS_D);

PHPAPI MYSQLND * zval_to_mysqlnd(zval * zv, TSRMLS_D);
