...
PHPAPI void
mysqlnd_fill_stats_hash(const MYSQLND_STATS * const stats, const MYSQLND_STRING * names, zval *return_value, TSRMLS_D ZEND_FILE_LINE_DC)
{
	unsigned int i;
...
PHPAPI void
_mysqlnd_get_client_stats(zval *return_value, TSRMLS_D ZEND_FILE_LINE_DC)
{
	...
	mysqlnd_fill_stats_hash(stats_ptr, mysqlnd_stats_values_names, return_value, TSRMLS_C ZEND_FILE_LINE_CC);
	DBG_VOID_RETURN;
}
/* }}} */
...
mysqlnd_stats_set_trigger(MYSQLND_STATS * const stats, enum_mysqlnd_collected_stats statistic, mysqlnd_stat_trigger trigger, TSRMLS_D)
{
...
PHPAPI mysqlnd_stat_trigger
mysqlnd_stats_reset_triggers(MYSQLND_STATS * const stats, TSRMLS_D)
{
	mysqlnd_stat_trigger ret = NULL;
