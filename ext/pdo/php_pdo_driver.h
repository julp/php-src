...
static inline long pdo_attr_lval(zval *options, enum pdo_attribute_type option_name, long defval, TSRMLS_D)
{
	zval **v;
...
static inline char *pdo_attr_strval(zval *options, enum pdo_attribute_type option_name, char *defval, TSRMLS_D)
{
	zval **v;
...
#define PDO_DRIVER_HEADER(name)	\
	 ...
	 * are used.
	 */
	int (*db_handle_factory)(pdo_dbh_t *dbh, zval *driver_options, TSRMLS_D);
...
typedef int (*pdo_dbh_close_func)(pdo_dbh_t *dbh, TSRMLS_D);

/* prepare a statement and stash driver specific portion into stmt */
typedef int (*pdo_dbh_prepare_func)(pdo_dbh_t *dbh, const char *sql, long sql_len, pdo_stmt_t *stmt, zval *driver_options, TSRMLS_D);

/* execute a statement (that does not return a result set) */
typedef long (*pdo_dbh_do_func)(pdo_dbh_t *dbh, const char *sql, long sql_len, TSRMLS_D);

/* quote a string */
typedef int (*pdo_dbh_quote_func)(pdo_dbh_t *dbh, const char *unquoted, int unquotedlen, char **quoted, int *quotedlen, enum pdo_param_type paramtype, TSRMLS_D);

/* transaction related */
typedef int (*pdo_dbh_txn_func)(pdo_dbh_t *dbh, TSRMLS_D);

/* setting of attributes */
typedef int (*pdo_dbh_set_attr_func)(pdo_dbh_t *dbh, long attr, zval *val, TSRMLS_D);
...
typedef char *(*pdo_dbh_last_id_func)(pdo_dbh_t *dbh, const char *name, unsigned int *len, TSRMLS_D);
 ...
 *   specific data ...  */
typedef	int (*pdo_dbh_fetch_error_func)(pdo_dbh_t *dbh, pdo_stmt_t *stmt, zval *info, TSRMLS_D);

/* fetching of attributes */
typedef int (*pdo_dbh_get_attr_func)(pdo_dbh_t *dbh, long attr, zval *val, TSRMLS_D);
...
typedef int (*pdo_dbh_check_liveness_func)(pdo_dbh_t *dbh, TSRMLS_D);
 ...
 * scope */
typedef void (*pdo_dbh_request_shutdown)(pdo_dbh_t *dbh, TSRMLS_D);
...
typedef const zend_function_entry *(*pdo_dbh_get_driver_methods_func)(pdo_dbh_t *dbh, int kind, TSRMLS_D);
...
typedef int (*pdo_stmt_dtor_func)(pdo_stmt_t *stmt, TSRMLS_D);

/* start the query */
typedef int (*pdo_stmt_execute_func)(pdo_stmt_t *stmt, TSRMLS_D);
...
typedef int (*pdo_stmt_describe_col_func)(pdo_stmt_t *stmt, int colno, TSRMLS_D);
 ...
 */
typedef int (*pdo_stmt_get_col_data_func)(pdo_stmt_t *stmt, int colno, char **ptr, unsigned long *len, int *caller_frees, TSRMLS_D);
...
typedef int (*pdo_stmt_param_hook_func)(pdo_stmt_t *stmt, struct pdo_bound_param_data *param, enum pdo_param_event event_type, TSRMLS_D);

/* setting of attributes */
typedef int (*pdo_stmt_set_attr_func)(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D);

/* fetching of attributes */
typedef int (*pdo_stmt_get_attr_func)(pdo_stmt_t *stmt, long attr, zval *val, TSRMLS_D);
 ...
 */
typedef int (*pdo_stmt_get_column_meta_func)(pdo_stmt_t *stmt, long colno, zval *return_value, TSRMLS_D);
 ...
 * to the caller. */
typedef int (*pdo_stmt_next_rowset_func)(pdo_stmt_t *stmt, TSRMLS_D);
 ...
 * fetch all the rows. */
typedef int (*pdo_stmt_cursor_closer_func)(pdo_stmt_t *stmt, TSRMLS_D);
...
PDO_API void pdo_raise_impl_error(pdo_dbh_t *dbh, pdo_stmt_t *stmt,
	const char *sqlstate, const char *supp, TSRMLS_D);
