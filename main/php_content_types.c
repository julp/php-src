...
{
	sapi_register_default_post_reader(php_default_post_reader, TSRMLS_C);
	sapi_register_treat_data(php_default_treat_data, TSRMLS_C);
	sapi_register_input_filter(php_default_input_filter, NULL, TSRMLS_C);
	return SUCCESS;
}
/* }}} */
