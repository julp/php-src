...
PHPAPI char *expand_filepath_with_mode(const char *filepath, char *real_path, const char *relative_to, size_t relative_to_len, int use_realpath, TSRMLS_D);
...
PHPAPI int php_check_safe_mode_include_dir(const char *path, TSRMLS_D);

PHPAPI char *php_resolve_path(const char *filename, int filename_len, const char *path, TSRMLS_D);
