...
#define INIT_FUNC_ARGS		int type, int module_number, TSRMLS_D
#define INIT_FUNC_ARGS_PASSTHRU	type, module_number, TSRMLS_C
#define SHUTDOWN_FUNC_ARGS	int type, int module_number, TSRMLS_D
#define SHUTDOWN_FUNC_ARGS_PASSTHRU type, module_number, TSRMLS_C
#define ZEND_MODULE_INFO_FUNC_ARGS zend_module_entry *zend_module, TSRMLS_D
#define ZEND_MODULE_INFO_FUNC_ARGS_PASSTHRU zend_module, TSRMLS_C
...
struct _zend_module_entry {
	...
	void* globals_ptr;
#endif
	void (*globals_ctor)(void *global, TSRMLS_D);
	void (*globals_dtor)(void *global, TSRMLS_D);
...
int module_registry_request_startup(zend_module_entry *module, TSRMLS_D);
