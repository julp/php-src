...
static int
php_phttpd_sapi_ub_write(const char *str, uint str_length, TSRMLS_D)
{
    int sent_bytes;
...
static int
php_phttpd_sapi_header_handler(sapi_header_struct *sapi_header, sapi_headers_struct *sapi_headers, TSRMLS_D)
{
...
static int
php_phttpd_sapi_send_headers(sapi_headers_struct *sapi_headers, TSRMLS_D)
{
...
static int
php_phttpd_sapi_read_post(char *buf, uint count_bytes, TSRMLS_D)
{
/*
    uint max_read;
    uint total_read = 0;
...
static void
php_phttpd_request_ctor(TSRMLS_D, TSRMLS_D)
{
...
static void
php_phttpd_request_dtor(TSRMLS_D, TSRMLS_D)
{
