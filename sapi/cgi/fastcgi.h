...
typedef void (*fcgi_apply_func)(char *var, unsigned int var_len, char *val, unsigned int val_len, void *arg, TSRMLS_D);
...
void  fcgi_loadenv(fcgi_request *req, fcgi_apply_func load_func, zval *array, TSRMLS_D);
